...
let updatetask = await knex.where({ userid : data.userid , task_id : data.task_id }).update({ task: data.task , description : data.description }).into('task');
...
module.exports = { getUsers, login , create, createtask, gettask,updatetask};
